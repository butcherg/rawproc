...
class OCIOPanel: public PicProcPanel
{
	public:
		OCIOPanel(wxWindow *parent, PicProcessor *proc, wxString params): PicProcPanel(parent, proc, params)
		{
			...
			enablebox = new wxCheckBox(this, SHARPENENABLE, "ocio:");
			...
			SetFocus();
			t = new wxTimer(this);
			Bind(wxEVT_BUTTON, &OCIOPanel::OnButton, this);
			Bind(wxEVT_SCROLL_CHANGED, &OCIOPanel::OnChanged, this);
			Bind(wxEVT_SCROLL_THUMBTRACK, &OCIOPanel::OnThumbTrack, this);
			Bind(wxEVT_CHECKBOX, &OCIOPanel::onEnable, this, SHARPENENABLE);
			Bind(wxEVT_TIMER, &OCIOPanel::OnTimer,  this);
		}
